...
function switchToFacebook() {
  showTitlescreen(titlescreen2, () => {
    ...
    speedImages[0].src = '/images/bluecar.png';
    speedImages[1].src = '/images/blueplane.png';
    speedImages[2].src = '/images/bluerocket.png';
    
    const loadingCamera = document.querySelector('.cam-spin');
    if (loadingCamera) loadingCamera.src = '/images/shop.png';
  });
}
...
function switchToCarousell() {
  showTitlescreen(titlescreen, () => {
    ...
    const speedImages = document.querySelectorAll('.speed-image');
    speedImages[0].src = '/images/car.png';
    speedImages[1].src = '/images/plane.png';
    speedImages[2].src = '/images/rocket.png';
    
    const loadingCamera = document.querySelector('.cam-spin');
    if (loadingCamera) loadingCamera.src = '/images/camera.png';
  });
}
...
function switchToEbay() {
  showTitlescreen(titlescreen3, () => {
    ...
    mainLogo.src = '/images/logo3.png';
    currentScraper = 'ebay';
    
    const speedImages = document.querySelectorAll('.speed-image');
    speedImages[0].src = '/images/ebaycar.png';
    speedImages[1].src = '/images/ebayplane.png';
    speedImages[2].src = '/images/ebayrocket.png';
    
    const loadingCamera = document.querySelector('.cam-spin');
    if (loadingCamera) loadingCamera.src = '/images/shoppingbag.png';
  });
}
